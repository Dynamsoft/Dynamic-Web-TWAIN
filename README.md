...
Note: Dynamic Web TWAIN SDK **v19.3.2** is built in this package. For more detail, check the [Version Info](#versions).
...
>
>**v19.3.2** (build version 1, 9, 3, 1028)
>
>`Dynamic Web TWAIN Service Manager (DWASManager_19301028.dll, 64bit)`
>
>**v19.3.2** (build version 19, 3, 0, 1028)
>
...
>
>**v19.3.2** (build version 12, 0, 2, 0228)
>
...
>
>**v19.3.2** (build version 19, 2, 0, 0826)
>
>`Dynamsoft Upload Module (UploadModule_1.9.0.0318.dll, 64bit)`
>
>**v19.3.2** (build version 1, 9, 0, 0318)
